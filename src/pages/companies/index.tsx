...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'category.count', 'page.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('category', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('page', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'page',
          header: 'Page',
          accessorKey: 'page',
          cell: ({ row: { original: record } }: any) => record?._count?.page,
        }
      : null,
